...
Our PositionManager implement additional [fair launch](/broken/pages/lFhHyyRQ0jfablvBjxW3) and [internal swap](/broken/pages/smeg8ZtgPS8aRNPaBobU) mechanisms that occurs before the standard Uniswap swap flow. This internal swap is used to handle fee conversions and distributions within the protocol and Fair Launch is used to handle swaps before committing liquidity to Uniswap.
